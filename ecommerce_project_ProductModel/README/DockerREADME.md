...
### 🔧 1. Application Properties for Docker
...
### 🐳 2. Dockerfile (Backend Container Build)
...
### 🧱 4. docker-compose.yml (Run Backend + MySQL Together)
...
#### Local MySQL is running → stop service OR change ports:
```text
 "3307:3306"
```
